...
REAL_CLINICAL_SOUNDS = {
    # ── HEART SOUNDS ────────────────────────────────────────────────────
    "normal_heart": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/normal-heart-sounds.mp3",
        "label": "Normal Heart Sounds (S1–S2)",
        "source": "Easy Auscultation Reference Library",
    ...
    "murmur": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/aortic-stenosis.mp3",
    ...
    "s3_gallop": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/s3-gallop.mp3",
    ...
    "s4_gallop": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/s4-gallop.mp3",
    ...
    "pericardial_rub": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/pericardial-rub.mp3",
    ...
    # ── LUNG SOUNDS ─────────────────────────────────────────────────────
    "normal_breath": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/normal-vesicular.mp3",
    ...
    "crackles_fine": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/fine-crackles.mp3",
    ...
    "crackles_coarse": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/coarse-crackles.mp3",
    ...
    "crackles": {  # alias used by render_medical_sound_player
        "url": "https://www.easyauscultation.com/audio/SoundFiles/coarse-crackles.mp3",
    ...
    "wheeze_exp": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/wheezes.mp3",
    ...
    "ronchi": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/rhonchi.mp3",
        "label": "Rhonchi",
        "source": "Easy Auscultation Reference Library",
    ...
    "absent_breath": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/diminished.mp3",
    ...
    "pleural_rub": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/pleural-rub.mp3",
    ...
    "stridor": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/stridor.mp3",
    ...
    # ── BOWEL SOUNDS ────────────────────────────────────────────────────
    "bowel_normal": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/bowel-normal.mp3",
    ...
    "bowel_hyperactive": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/bowel-hyperactive.mp3",
    ...
    "bowel_absent": {
        "url": "https://www.easyauscultation.com/audio/SoundFiles/bowel-absent.mp3",
...
def render_real_recording_player(sound_type: str) -> None:
    """
    Render an HTML5 <audio> player for the given sound type.
    Streams MP3 directly from public educational source.
    Returns nothing if sound_type is unknown.
    """
